...
agent = create_agent(
    system_prompt=(
        "Você é um robô aspirador autônomo em uma casa linear n  salas.\n"
        "SUA VISÃO É LIMITADA: Você só pode ver a sala onde está parado no momento.\n"
        "Seu objetivo é garantir que TODAS as salas estejam limpas.\n"
        "Estratégia sugerida:\n"
        ...
        "Certifique-se de verificar as salas antes de concluir a tarefa."
